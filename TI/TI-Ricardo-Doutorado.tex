...
para isso usou-se os arquivos .bib exportados pelas ferramentas das bases de busca, com exceção apenas da Spriger que necessitou o uso intermediário do Zootero para execução de uma outra filtragem dos artigos ja que não havia na mesma a opção de realizar busca sobre os metadados.
