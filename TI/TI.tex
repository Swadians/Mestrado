...
\begin{itemize}
	\item \textbf{Tecnologia de Processamento de Eventos:} dentre os artigos selecionados durante o mapeamento identificou-se que apenas dois destes, \cite{art1aslam2018towards} e \cite{art5chen2016dress} trabalhavam com ESP, todos os demais trabalhos aplicam de alguma forma em suas soluções o CEP. 
	
	
	
	\begin{figure}[ht]
		\centering
		\includegraphics[width=.6\textwidth]{imagens/comparacaoArtigos.png}
	...
	\item \textbf{Tecnologia de Inteligencia Artificial:} das propostas analisadas, quatro destas implementaram alguma  técnica de aprendizado de maquina para solucionar os problemas abordados, os quais foram \cite{art1aslam2018towards}, \cite{art4akbar2017predictive}, \cite{art9kousiouris2018integrated} e \cite{art10soto2016ceml}.
	
	\item \textbf{Ferramentas:} nesta coluna mostrada na figura \ref{fig:comparacaoArtigos} foram selecionados as principais ferramentas citadas nos documentos de cada uma das propostas analisadas.
	
    \item \textbf{Cenário:} os artigos selecionados são separados pelas áreas que este estes propuseram uma solução das quais foram identificadas IoT Multimídia, Big Data, Agricultura de Precisão, Aprendizado de Maquina, Smart Cities e Segurança.
    
     \item \textbf{Reusabilidade:} demonstra se o trabalho apresenta detalhes suficientes que
      permitem a reimplementação da proposta, sendo passível de replicação dos testes realizados; 
